...
// grey
GLfloat colors[] = {1.0f,1.0f,1.0f,  0.9f,0.9f,0.9f,  0.7f,0.7f,0.7f,  0.8f,0.8f,0.8f,              // v0-v1-v2-v3
                    1.0f,1.0f,1.0f,  0.8f,0.8f,0.8f,  0.7f,0.7f,0.7f,  0.8f,0.8f,0.8f,              // v0-v3-v4-v5
                    1.0f,1.0f,1.0f,  0.9f,0.9f,0.9f,  0.7f,0.7f,0.7f,  0.9f,0.9f,0.9f,              // v0-v5-v6-v1
                    0.9f,0.9f,0.9f,  0.7f,0.7f,0.7f,  0.15f,0.15f,0.15f,  0.7f,0.7f,0.7f,              // v1-v6-v7-v2
                    0.15f,0.15f,0.15f,  0.7f,0.7f,0.7f,  0.8f,0.8f,0.8f,  0.7f,0.7f,0.7f,              // v7-v4-v3-v2
                    0.7f,0.7f,0.7f,  0.15f,0.15f,0.15f,  0.7f,0.7f,0.7f,  0.9f,0.9f,0.9f};             // v4-v7-v6-v5
...
{ 
   ...
   // current ray part
   {
      ...
      drawTorusAt(0.0015f, 0.0045f, sectP, rotAxis);
   ...
   for(int i = 0; i <= min(intersectionFoundCycle, Settings::Instance()->getMipmapTestCycleIndex()); i++)
   {
      ...
      if(!(glm::all(glm::equal(glm::uvec4(0), bitRays[i]))))
      {
         ...
         if(i < glm::min(intersectionFoundCycle, Settings::Instance()->getMipmapTestCycleIndex()))
         {
            ...
            drawCylinderBox(0.003f, hitBoxMin, hitBoxMax);
